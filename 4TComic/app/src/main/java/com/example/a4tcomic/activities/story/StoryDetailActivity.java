...
public class StoryDetailActivity extends AppCompatActivity {
    ...
    private FavoritesDB favoritesDB = new FavoritesDB();
    private GenresDB genresDB = new GenresDB();
    private ChaptersDB chaptersDB = new ChaptersDB();
    ...
    private void goToReadPage(Chapter chapter) {
        historyDB.addComicReadByUser(chapter, user_id);
        if (chapter == null) {
