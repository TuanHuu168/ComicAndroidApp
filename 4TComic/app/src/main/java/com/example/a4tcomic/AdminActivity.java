...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentList.add(new CommentItem(R.drawable.truyen1, "Tiểu Thư Bé Bỏng Đáng Yêu!", "Tùng", "Ôi cô công chúa sinh quá. Ước gì mình cũng có cô con gái như vậy", "29 phút"));
